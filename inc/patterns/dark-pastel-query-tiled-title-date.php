<?php
/**
 * Tiled title and date query loop block pattern
 */
return array(
	'title'      => __( 'Tiled title and date query loop', 'darkpastel' ),
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
                    ...
                    <!-- wp:post-title {"textAlign":"center","level":3,"isLink":true,"style":{"spacing":{"margin":{"bottom":"0","top":"var:preset|spacing|20"}}},"fontSize":"medium"} /-->
